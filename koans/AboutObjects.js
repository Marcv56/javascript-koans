describe("About Objects", function () {
    ...
    var megalomaniac = {
      ...
      battleCry: function (noOfBrains) {
        return "They are " + this.henchman + " and the" +
          // Array(noOfBrains + 1) creates an array of noOfBrains + 1 length
          // The join methods joins the empty values together placing " " + this.matermind between each empty item
  ...
  it("should use prototype to add to all objects", function () {
      ...
      expect(colouredCircle.describe()).toBe("This circle has a radius of: 5s";
  });
});
