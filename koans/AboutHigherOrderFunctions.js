...
describe("About Higher Order Functions", function () {
  ...
  it("should use filter to return array items that meet a criteria", function () {
    ...
    expect(odd).toEqual([1,3]);; //odd numbers in the string
    expect(odd.length).toBe(2); //length of the odd numbers
    expect(numbers.length).toBe(3); // length of the total numbers
  });
